...
export const LESSON_COPY_JA = {
  ...
  overviewCard: {
    ...
    flowStep1Sub: '意味をつかむ',
    flowStep2Label: 'リピート',
    flowStep2Sub: '音でマネして話す',
    flowStep3Label: 'チャレンジ',
...
export const LESSON_COPY_EN = {
  ...
  activeCard: {
    ...
    aiConvRecognizing: 'Checking your voice',
  ...
  overviewCard: {
    ...
    defaultSceneDescription: 'Today you will practice listening, speaking, and using the expression in conversation.',
    levelLabel: 'Level',
    ...
    lessonStartDescription:
      'You will build it step by step through listening, repeating, answering the AI, and conversation.',
    ...
    flowStep2Sub: 'Copy the sound and rhythm',
    flowStep3Label: 'Challenge',
    flowStep3Sub: 'Recall and answer',
    flowStep4Label: 'AI Question',
    flowStep4Sub: 'Respond in conversation form',
    flowStep5Label: 'AI Conversation',
    flowStep5Sub: 'Freely interact',
