        ...
        <Sec bg="#fff" id="faq">
          ...
          <div style={{display:'flex',flexDirection:'column',gap:12}}>
            {[
              ...
              {q:'いつでも解約できますか？',a:'はい。解約はいつでも可能です。解約後もお支払い済みの期間が終了するまでレッスンを続けてご利用いただけます。すぐにアクセスが止まることはありません。'},
              {q:'解約したらすぐにレッスンが使えなくなりますか？',a:'いいえ。解約後も現在のお支払い期間が終わるまでレッスンをご利用いただけます。'},
              {q:'月額から年額に変更できますか？',a:'はい。お支払い設定からいつでもプラン変更が可能です。現在のプランは期間終了まで有効で、新しいプランはその後から適用されます。'},
