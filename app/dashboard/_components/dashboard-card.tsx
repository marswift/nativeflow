...
export default function DashboardCard({
  ...
  return (
    <Link
      ...
      className={`group block rounded-2xl border p-5 transition duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 ${
        isCompleted
