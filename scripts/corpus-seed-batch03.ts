/**
 * Corpus Seed Insert Runner — Batch 03
 *
 * Usage:
 *   npx tsx scripts/corpus-seed-batch03.ts
 *
 * Reads: data/corpus/manual-seed-en-us-v1-batch-03.json
...
async function main() {
  const filePath = resolve(__dirname, '../data/corpus/manual-seed-en-us-v1-batch-03.json')

  console.log('=== Corpus Seed Insert: Batch 03 ===')
